...
"""API configuration"""
​
CLIENT_SECRETS_FILE = 'sample_data/client_secret.json'
...
client_id = client_secret_creds['web']['client_id']
client_secret = client_secret_creds['web']['client_secret']
...
f = open('sample_data/access_code','r')
code = f.read()
f.close()
print(code[:40])
​
...
​
    ...
    tokens = requests.post(url, payload)
    return_token = json.loads(tokens.content.decode('utf-8'))
    print(return_token)
    return (return_token['access_token'],return_token['refresh_token'])
​
